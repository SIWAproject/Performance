...
colnames(taxonomy)
grouped <- aggregate_taxa_siwa(phyloseq_relative, "species")
...
# run each time for every aggregate taxa (genus and species)
grouped_genus = grouped
grouped_genus$Taxa_aggre = "genus"


grouped_species = grouped
grouped_species$Taxa_aggre = "species"

#rbind df aggregate_taxa_siwa by genus and species
grouped_gen_spe = rbind(grouped_genus, grouped_species)

"/Users/sebastianbedoyamazo/Library/CloudStorage/GoogleDrive-sebastian.bedoya@premexcorp.com/Mi unidad/siwa_shared/Analisis/Performance exploration/"


write.csv(species_otu_table_filtered_transformed_log, file = "/Users/sebastianbedoyamazo/Library/CloudStorage/GoogleDrive-sebastian.bedoya@premexcorp.com/.shortcut-targets-by-id/1j_mPOvs6DPPqRINFw74_ARcBZ9HwkQpE/Performance exploration/corr_results/species_otu_table_filtered_transformed_log.csv", row.names = TRUE)
...
#run
#otu_table<-grouped_genus[,samplesE347]
otu_table <- grouped
meta_exp <- meta_exp
...
```{r method  keep taxa clr_transf, include=FALSE}

#keep taxa (species or genus CLR transform)
# genus_otu_table_filtered_transformed_log = otu_table_filtered_transformed_log
# species_otu_table_filtered_transformed_log = otu_table_filtered_transformed_log
...
corr_347_genus =  correlation_siwa(X, Y, groups_,  method="pearson")
...
corr_analysis_species = rbind(corr_267_specie, corr_271_specie, corr_345_specie, corr_347_specie)
...
corr_analysis = rbind(corr_analysis_species, corr_analysis_genus)



# write.csv(corr_analysis, file = "/Users/sebastianbedoyamazo/Library/CloudStorage/GoogleDrive-sebastian.bedoya@premexcorp.com/.shortcut-targets-by-id/1j_mPOvs6DPPqRINFw74_ARcBZ9HwkQpE/Performance exploration/corr_results/corr_analysis.csv", row.names = FALSE)
